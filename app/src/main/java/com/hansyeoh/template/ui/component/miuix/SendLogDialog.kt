package com.hansyeoh.template.ui.component.miuix
...
import com.hansyeoh.template.ui.component.dialog.LoadingDialogHandle
        ...
        content = {
            ...
            SuperArrow(
                ...
                onClick = {
                    ...
                    exportBugreportLauncher.launch("Template_bugreport_${current}.tar.gz")
                    onDismissRequest()
                },
