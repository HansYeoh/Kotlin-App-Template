package com.hansyeoh.template.ui.component.dialog
...
import com.hansyeoh.template.ui.component.GithubMarkdown
            ...
            Layout(
                content = {
                    visuals.content?.let { content ->
                        when {
                            visuals.isMarkdown -> GithubMarkdown(content = content)
